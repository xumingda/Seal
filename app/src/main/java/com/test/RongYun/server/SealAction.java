...
import com.test.RongYun.request.AddGroupMemberRequest;
import com.test.RongYun.request.AddToBlackListRequest;
import com.test.RongYun.request.AgreeFriendsRequest;
import com.test.RongYun.request.ChangePasswordRequest;
import com.test.RongYun.request.CheckPhoneRequest;
import com.test.RongYun.request.CreateGroupRequest;
import com.test.RongYun.request.DeleteFriendRequest;
import com.test.RongYun.request.DeleteGroupMemberRequest;
import com.test.RongYun.request.DismissGroupRequest;
import com.test.RongYun.request.FriendInvitationRequest;
import com.test.RongYun.request.JoinGroupRequest;
import com.test.RongYun.request.LoginRequest;
import com.test.RongYun.request.QuitGroupRequest;
import com.test.RongYun.request.RegisterRequest;
import com.test.RongYun.request.RemoveFromBlacklistRequest;
import com.test.RongYun.request.RestPasswordRequest;
import com.test.RongYun.request.SendCodeRequest;
import com.test.RongYun.request.SetFriendDisplayNameRequest;
import com.test.RongYun.request.SetGroupDisplayNameRequest;
import com.test.RongYun.request.SetGroupNameRequest;
import com.test.RongYun.request.SetGroupPortraitRequest;
import com.test.RongYun.request.SetNameRequest;
import com.test.RongYun.request.SetPortraitRequest;
import com.test.RongYun.request.VerifyCodeRequest;
import com.test.RongYun.response.AddGroupMemberResponse;
import com.test.RongYun.response.AddToBlackListResponse;
import com.test.RongYun.response.AgreeFriendsResponse;
import com.test.RongYun.response.ChangePasswordResponse;
import com.test.RongYun.response.CheckPhoneResponse;
import com.test.RongYun.response.CreateGroupResponse;
import com.test.RongYun.response.DefaultConversationResponse;
import com.test.RongYun.response.DeleteFriendResponse;
import com.test.RongYun.response.DeleteGroupMemberResponse;
import com.test.RongYun.response.DismissGroupResponse;
import com.test.RongYun.response.FriendInvitationResponse;
import com.test.RongYun.response.GetBlackListResponse;
import com.test.RongYun.response.GetFriendInfoByIDResponse;
import com.test.RongYun.response.GetGroupInfoResponse;
import com.test.RongYun.response.GetGroupMemberResponse;
import com.test.RongYun.response.GetGroupResponse;
import com.test.RongYun.response.GetRegionListResponse;
import com.test.RongYun.response.GetTokenResponse;
import com.test.RongYun.response.GetUserInfoByIdResponse;
import com.test.RongYun.response.GetUserInfoByPhoneResponse;
import com.test.RongYun.response.GetUserInfosResponse;
import com.test.RongYun.response.JoinGroupResponse;
import com.test.RongYun.response.LoginResponse;
import com.test.RongYun.response.QiNiuTokenResponse;
import com.test.RongYun.response.QuitGroupResponse;
import com.test.RongYun.response.RegisterResponse;
import com.test.RongYun.response.RemoveFromBlackListResponse;
import com.test.RongYun.response.RestPasswordResponse;
import com.test.RongYun.response.SendCodeResponse;
import com.test.RongYun.response.SetFriendDisplayNameResponse;
import com.test.RongYun.response.SetGroupDisplayNameResponse;
import com.test.RongYun.response.SetGroupNameResponse;
import com.test.RongYun.response.SetGroupPortraitResponse;
import com.test.RongYun.response.SetNameResponse;
import com.test.RongYun.response.SetPortraitResponse;
import com.test.RongYun.response.SyncTotalDataResponse;
import com.test.RongYun.response.UserRelationshipResponse;
import com.test.RongYun.response.VerifyCodeResponse;
import com.test.RongYun.response.VersionResponse;
import com.test.RongYun.utils.JsonMananger;
...
public class SealAction extends BaseAction {
    ...
    * */
     ...
     * 通过国家码和手机号查询用户信息
     *
     * @param authorization 接口凭证
     * @param searchKey  手机号
     * @throws HttpException
     */
    public GetUserInfoByPhoneResponse getUserInfoFromPhone(String authorization, String searchKey) throws HttpException {
        String url = getURL("user/searchUser/" + authorization + "/" + searchKey);
        String result = httpManager.get(url);
        LogUtils.e("地址："+url);
