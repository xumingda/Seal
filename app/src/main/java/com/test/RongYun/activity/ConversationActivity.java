...
import com.test.RongYun.fragment.ConversationFragmentEx;
...
import com.test.RongYun.widget.LoadingDialog;
...
public class ConversationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("mTargetId","mTargetId"+mTargetId);
        ...
        // xmd修改正常逻辑，跟本地id不同
//        if (mTargetId != null && !mTargetId.equals(SharedPrefrenceUtils.getString(mContext,"userid"))) {
//            startActivity(new Intent(ConversationActivity.this, NewFriendListActivity.class));
//            return;
//        }
