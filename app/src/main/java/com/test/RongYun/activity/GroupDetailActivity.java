...
import com.test.RongYun.bean.SealSearchConversationResult;
...
import com.test.RongYun.utils.OperationRong;
import com.test.RongYun.utils.PhotoUtils;
import com.test.RongYun.utils.RongGenerate;
import com.test.RongYun.utils.SealConst;
import com.test.RongYun.utils.SealUserInfoManager;
import com.test.RongYun.widget.BottomMenuDialog;
import com.test.RongYun.widget.DemoGridView;
...
import com.test.RongYun.widget.SwitchButton;
...
public class GroupDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initGroupData() {
        ...
        ImageLoader.getInstance().displayImage(portraitUri, mGroupHeader, BaseApplication.getOptions());
            ...
            switch (requestCode) {
                ...
                case UPDATE_GROUP_HEADER:
                    ...
                    if (response5.getCode() == 200) {
                        ImageLoader.getInstance().displayImage(imageUrl, mGroupHeader, BaseApplication.getOptions());
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == getCount() - 1 && isCreated) {
                ...
                iv_avatar.setBackground(getResources().getDrawable(R.mipmap.icon_btn_deleteperson));
                ...
                tv_username.setText("");
                badge_delete.setVisibility(View.GONE);
                iv_avatar.setBackground(getResources().getDrawable(R.mipmap.jy_drltsz_btn_addperson));
                ...
                ImageLoader.getInstance().displayImage(portraitUri, iv_avatar, BaseApplication.getOptions());
                iv_avatar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
