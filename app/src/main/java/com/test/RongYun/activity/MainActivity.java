...
import com.test.RongYun.adapter.ConversationListAdapterEx;
import com.test.RongYun.base.BaseActivity;
import com.test.RongYun.base.BaseApplication;
import com.test.RongYun.fragment.ContactsFragment;
import com.test.RongYun.fragment.DiscoverFragment;
import com.test.RongYun.fragment.MineFragment;
import com.test.RongYun.server.BroadcastManager;
import com.test.RongYun.server.HomeWatcherReceiver;
import com.test.RongYun.utils.NToast;
import com.test.RongYun.utils.SharedPrefrenceUtils;
import com.test.RongYun.widget.DragPointView;
import com.test.RongYun.widget.LoadDialog;
import com.test.RongYun.widget.MorePopWindow;
...
public class MainActivity extends BaseActivity implements
    ...
    private void changeTextViewColor() {
        ...
        mTextChats.setTextColor(Color.parseColor("#999999"));
        mTextContact.setTextColor(Color.parseColor("#999999"));
        mTextFind.setTextColor(Color.parseColor("#999999"));
        mTextMe.setTextColor(Color.parseColor("#999999"));
    }

    private void changeSelectedTabState(int position) {
        switch (position) {
            case 0:
                mTextChats.setTextColor(Color.parseColor("#22C990"));
                mImageChats.setBackgroundDrawable(getResources().getDrawable(R.mipmap.tab_chat_hover));
                break;
            case 1:
                mTextContact.setTextColor(Color.parseColor("#22C990"));
                mImageContact.setBackgroundDrawable(getResources().getDrawable(R.mipmap.tab_contacts_hover));
                break;
            case 2:
                mTextFind.setTextColor(Color.parseColor("#22C990"));
                mImageFind.setBackgroundDrawable(getResources().getDrawable(R.mipmap.tab_found_hover));
                break;
            case 3:
                mTextMe.setTextColor(Color.parseColor("#22C990"));
    ...
    private void getPushMessage() {
        ...
        if (intent != null && intent.getData() != null && intent.getData().getScheme().equals("rong")) {
            ...
            if (path.contains("push_message")) {
                String cacheToken = SharedPrefrenceUtils.getString(mContext,"token");
